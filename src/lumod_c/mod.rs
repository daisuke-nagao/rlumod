...
//! The public compatibility surface consists of [`LUmod`], [`Lprod`], and
//! [`Usolve`].
//!
...
//!
//! Internal factor-update building blocks are not part of this Rust API:
//!
//! ```compile_fail,E0425
//! let _ = rlumod::lumod_c::LUforw;
//! ```
//!
//! ```compile_fail,E0425
//! let _ = rlumod::lumod_c::LUback;
//! ```
//!
//! ```compile_fail,E0425
//! let _ = rlumod::lumod_c::elm;
//! ```
//!
//! ```compile_fail,E0425
//! let _ = rlumod::lumod_c::elmgen;
//! ```
//!
//! # Example
//!
